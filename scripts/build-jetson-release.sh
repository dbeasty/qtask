...
echo "  ./scripts/publish-jetson-release.sh qtask@192.168.13.14"
echo ""
echo "Or manually:"
echo "  scp ${ARCHIVE} qtask@192.168.13.14:"
echo "  ssh qtask@192.168.13.14 'tar xzf qtask-ollama-${VERSION}-jetson.tar.gz && cd qtask-ollama-${VERSION} && ./deploy/deploy-jetson-ollama.sh'"
