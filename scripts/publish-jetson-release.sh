...
# Usage:
#   JETSON_SSH=qtask@192.168.13.14 ./scripts/publish-jetson-release.sh
#   ./scripts/publish-jetson-release.sh qtask@192.168.13.14
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
cd "${ROOT}"

JETSON_SSH="${1:-${JETSON_SSH:-qtask@192.168.13.14}}"
